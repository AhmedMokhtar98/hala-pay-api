...
const { registerValidation, loginValidation, emailCheckValidation, sendOtpValidation, phoneCheckExistValidation, verifyOtpValidation, forgotPasswordValidation, resetPasswordValidation, refreshTokenValidation } = require("../../validations/client.auth.validation");
